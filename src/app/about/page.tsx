    ...
    <>
      <section className="relative top-[-20] flex flex-col items-center justify-center min-h-screen text-black overflow-x-clip">
        <div className="max-w-full h-[200px] sm:w-[500px]">
          <div
            className="absolute top-14 shadow-lg left-[-12%] h-[180px] bg-gradient-to-r from-[#50D210] to-[#50D210] z-[-3]"
            style={{
        ...
        <div className="absolute lg:top-[40%] top-[45%] flex flex-col items-center justify-center z-10 text-center h-fit">
        ...
        <div className="absolute lg:top-[50%] top-[60%] block z-10 mt-14">
          <a
            href="#contact"
      ...
      <section className="relative flex flex-col md:flex-row items-center justify-between min-h-screen text-black lg:px-36 lg:py-16 overflow-x-clip">
        ...
        >
          <div
            className="relative right-[50%] h-[180px] bg-gradient-to-l from-[#50D210] to-[#50D210] z-[-2] shadow-above"
            style={{
      ...
      <section className="relative flex md:flex-row text-right h-[80%] text-black lg:px-16 lg:py-16">
        ...
        <div className="relative flex flex-col max-w-full pr-10 pb-10 items-end justify-end lg:pr-20">
          ...
          <div className="mb-4 flex mt-10 justify-end">
      ...
      <section className="relative flex flex-col md:flex-row items-center justify-between min-h-screen text-black lg:px-36 lg:py-16 overflow-x-clip">
        ...
        <div className="max-w-full h-[200px] sm:w-[500px]">
          <div
            className="absolute shadow-above top-[-40%] left-[-12%] h-[180px] bg-gradient-to-r from-[#50D210] to-[#50D210] z-[-1]"
            style={{
              transform: 'rotate(30deg)',
              width: '160%',
              transformOrigin: 'left center',
